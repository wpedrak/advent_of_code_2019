...
class Laser:
    ...
    def aprox(self):
        ...
        return (top_theta + bot_theta) / 2


def solve(tape):
    laser = Laser(tape)
    print('Estimating borders...')
    laser.find_borders(100)
    aprox = laser.aprox()
    print('Borders estimated')

    print(aprox)
    print(laser.get_info(Point(int(10), int(10 * aprox))))
    print(laser.get_info(Point(int(100), int(100 * aprox))))
    print(laser.get_info(Point(int(1000), int(1000 * aprox))))
    print(laser.get_info(Point(int(10000), int(10000 * aprox))))
    # laser.display()
